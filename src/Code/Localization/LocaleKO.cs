    ...
    public class LocaleKO : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            ...
            */
            ...
            {
                { m_Setting.GetSettingsLocaleID(), "구역 그룹" },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.OverlayBorderWidth)), "지도에 표시되는 구역 그룹 경계선의 너비입니다." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.OverlayBorderAlpha)), "테두리 불투명도" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.OverlayBorderAlpha)), "지도에 표시되는 구역 그룹 경계선의 불투명도입니다.\n\n0%면 완전히 투명하고, 100%면 완전히 불투명합니다." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.OverlayBorderHeightOffset)), "높이 오프셋" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.OverlayBorderHeightOffset)), "구역 그룹 오버레이가 그려지는 높이를 지형 높이로부터 얼마나 띄울지 설정합니다." },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.OverlayFillSaturationPercent)), "색상이 있는 구역 그룹 채우기 영역의 채도입니다.\n\n100%면 그룹의 원래 색상이 되고, 값이 낮을수록 회색에 가까워집니다." },
                ...
                { LocalizationKey.DisplayDistrictAreasLabel, "모든 구역 표시" },
                { LocalizationKey.ShowGroupOverlayLabel, "그룹 오버레이 표시" },

                { LocalizationKey.DeleteGroupTooltipLine1, "그룹을 영구적으로 삭제합니다." },
                { LocalizationKey.DeleteGroupTooltipLine2, "할당된 건물은 **운영 구역**을 잃게 됩니다." },
                ...
                { LocalizationKey.DeleteGroupDialogTitle, "구역 그룹을 삭제하시겠습니까?" },
                { LocalizationKey.DeleteGroupConfirm, "그룹 삭제" },
                { LocalizationKey.DeleteGroupCancel, "그룹 유지" },
                { LocalizationKey.RemoveMemberTooltip, "그룹에서 이 구역을 제거합니다." },
                { LocalizationKey.SelectDistrictsButton, "구역 선택" },
                { LocalizationKey.GroupColorTooltip, "그룹 색상" },

                { LocalizationKey.ToggleTooltipTitle, "**구역 그룹**" },
                { LocalizationKey.ToggleTooltipBody, "구역 그룹을 만들어 서비스 건물에 할당하면 **운영 구역**이 자동으로 관리됩니다." },

                { LocalizationKey.SectionTooltipLine1, "서비스 건물은 **구역 그룹**에 할당할 수 있습니다." },
                { LocalizationKey.SectionTooltipLine2, "할당하면 그룹이 해당 건물의 **운영 구역**을 관리합니다." },
                { LocalizationKey.SectionTooltipLine3, "할당을 해제하면 **운영 구역**을 수동으로 관리합니다." },
                { LocalizationKey.SectionTooltipLine4, "참고: 할당을 변경한 후 정보 패널이 화면에 반영되기까지 몇 초 정도 걸릴 수 있습니다." },
                { LocalizationKey.SectionLabel, "구역 그룹" },
                { LocalizationKey.OperatingDistrictsLabel, "운영 구역" },
                ...
                { LocalizationKey.GroupSearchTitle, "구역 그룹 선택" },
