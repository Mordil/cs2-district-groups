        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            ...
            */
            ...
            return new Dictionary<string, string>
            {
                ...
                { LocalizationKey.DeleteGroupTooltipLine2, "已指派的建築將失去其**服務轄區**。" },
                ...
                { LocalizationKey.ToggleTooltipBody, "建立行政區群組並指派給服務建築，自動管理其**服務轄區**。" },

                { LocalizationKey.SectionTooltipLine1, "服務建築可以被指派給**行政區群組**。" },
                { LocalizationKey.SectionTooltipLine2, "指派後，群組將為該建築管理**服務轄區**。" },
                { LocalizationKey.SectionTooltipLine3, "取消指派後，**服務轄區**將改為手動管理。" },
                { LocalizationKey.SectionTooltipLine4, "注意：變更指派後，資訊面板可能需要幾秒鐘才會更新顯示。" },
                { LocalizationKey.SectionLabel, "行政區群組" },
                { LocalizationKey.OperatingDistrictsLabel, "服務轄區" },
