        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            ...
            */
            ...
            return new Dictionary<string, string>
            {
                ...
                { LocalizationKey.FilterTooltipAssignmentsLine1, "Filtra la lista de edificios de servicio por su **tipo**." },
                ...
                { LocalizationKey.TypePickerTooltipLine2, "Los grupos **cívicos** se pueden asignar a cualquier edificio de servicio." },
                ...
                { LocalizationKey.RemoveBuildingTooltip, "Elimina el edificio del grupo." },
                ...
                { LocalizationKey.OverviewTabLabel, "Resumen" },
                ...
                { LocalizationKey.NoDistrictsInGroup, "No hay distritos en este grupo. Añade distritos con el botón SELECCIONAR DISTRITOS." },
                ...
                { LocalizationKey.ClearPolicyFromGroupTooltip, "Retira la política de los {COUNT} distritos de este grupo." },
                ...
                { LocalizationKey.MembershipSectionTooltipLine1, "Los **grupos de distritos** a los que pertenece este distrito." },
                { LocalizationKey.MembershipSectionTooltipLine2, "Los edificios de servicio asignados a cualquiera de estos grupos prestarán servicio a este distrito." },
