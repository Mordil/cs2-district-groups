        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            ...
            */
            ...
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.OverlayBorderTransparency)), "Transparence de la bordure" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.OverlayBorderTransparency)), "Transparence des lignes de délimitation des quartiers tracées sur la superposition.\n\n0 % est entièrement opaque, 100 % est entièrement transparent." },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.OverlayEnableGroupLabels)), "Afficher les étiquettes des groupes" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.OverlayEnableGroupLabels)), "Lorsque cette option est activée, les noms des groupes s'affichent avec la superposition sur la carte.\n\nCela peut affecter les performances." },
                ...
                { LocalizationKey.HideAssignedBuildingsLabel, "Masquer les bâtiments assignés" },
                { LocalizationKey.HideAssignedBuildingsTooltip, "Masque les bâtiments de service déjà assignés à un **groupe de quartiers**." },
                ...
                { LocalizationKey.FilterTooltipAssignmentsLine1, "Filtre la liste des bâtiments de service par **type**." },
                ...
                { LocalizationKey.ShowServiceBuildingsLabel, "Afficher les bâtiments de service" },
                ...
                { LocalizationKey.TypePickerTooltipLine2, "Les groupes **civiques** peuvent être assignés à n'importe quel bâtiment de service." },
                ...
                { LocalizationKey.NoDistrictsInGroup, "Il n'y a aucun quartier dans ce groupe. Ajoutez des quartiers avec le bouton SÉLECTIONNER DES QUARTIERS." },
                ...
                { LocalizationKey.MembershipSectionLabel, "GROUPES DE QUARTIERS" },
                { LocalizationKey.MembershipSectionTooltipLine1, "Les **groupes de quartiers** auxquels ce quartier appartient." },
