        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            ...
            */
            ...
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.DumpDebugData)), "Schreibt den gesamten Mod-Zustand (Gruppen, Dienstleistungsgebäude usw.) in die Protokolldatei des Mods.\n\nFüge die Protokolldatei bei, wenn du einen Fehlerbericht einreichst." },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.RemoveModData)), "Löscht alle Bezirksgruppen, Zuweisungen von Dienstleistungsgebäuden und Overlay-Ressourcen, die der Mod dem aktuellen Spielstand hinzugefügt hat." },
                { m_Setting.GetOptionWarningLocaleID(nameof(Setting.RemoveModData)), "Alle Bezirksgruppen, Zuweisungen von Dienstleistungsgebäuden und Overlay-Daten werden endgültig aus diesem Spielstand gelöscht.\r\nDies kann nicht rückgängig gemacht werden.\r\nMöchtest du fortfahren?" },

                { LocalizationKey.PanelTitle, "District Groups" },
                { LocalizationKey.GroupsTabLabel, "Gruppen" },
                { LocalizationKey.AssignmentsTabLabel, "Dienstleistungsgebäude" },
                ...
                { LocalizationKey.FilterTooltipAssignmentsLine1, "Filtert die Liste der Dienstleistungsgebäude nach ihrem **Typ**." },
                ...
                { LocalizationKey.ShowServiceBuildingsLabel, "Dienstleistungsgebäude anzeigen" },
                ...
                { LocalizationKey.SectionTooltipLine1, "Dienstleistungsgebäude können einer **Bezirksgruppe** zugewiesen werden." },
                ...
                { LocalizationKey.MembershipSectionLabel, "BEZIRKSGRUPPEN" },
                { LocalizationKey.MembershipSectionTooltipLine1, "Die **Bezirksgruppen**, zu denen dieser Bezirk gehört." },
