        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            ...
            */
            ...
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.OverlayBorderWidth)), "Largura das linhas de contorno dos distritos desenhadas na sobreposição." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.OverlayBorderTransparency)), "Transparência da borda" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.OverlayBorderTransparency)), "Transparência das linhas de contorno dos distritos desenhadas na sobreposição.\n\n0% é totalmente opaco, 100% é totalmente transparente." },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.OverlayFillSaturationPercent)), "O quão saturadas são as áreas de preenchimento da sobreposição do grupo.\n\n100% é a cor completa do grupo; valores menores esmaecem em direção ao cinza." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.OverlayFillUseTransparency)), "Usar transparência do preenchimento" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.OverlayFillUseTransparency)), "Ativa a transparência para as áreas de preenchimento da sobreposição do grupo.\n\nQuando desativada, a sobreposição exibirá uma cor sólida e totalmente opaca que oculta todos os outros elementos visuais." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.OverlayEnableGroupLabels)), "Mostrar rótulos dos grupos" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.OverlayEnableGroupLabels)), "Quando ativada, os nomes dos grupos serão exibidos com a sobreposição no mapa.\n\nIsso pode afetar o desempenho." },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.RefreshRateSeconds)), "Taxa de atualização" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.RefreshRateSeconds)), "O número de segundos a esperar entre as atualizações da interface para informações agregadas de distritos.\n\nAtualizar com frequência pode afetar negativamente o desempenho." },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.ReleaseChannel)), "Canal de lançamento" },
                ...
                { LocalizationKey.AssignmentsTabLabel, "Edifícios de serviço" },
                { LocalizationKey.SelectTypeForAssignments, "Selecione um tipo de serviço para listar seus edifícios de serviço." },
                { LocalizationKey.NoServiceBuildingsMatchFilter, "Nenhum edifício de serviço corresponde a este filtro." },
                { LocalizationKey.HideAssignedBuildingsLabel, "Ocultar edifícios atribuídos" },
                { LocalizationKey.HideAssignedBuildingsTooltip, "Oculta os edifícios de serviço já atribuídos a um **grupo de distritos**." },
                ...
                { LocalizationKey.FilterTooltipAssignmentsLine1, "Filtra a lista de edifícios de serviço pelo **tipo**." },
                ...
                { LocalizationKey.ShowServiceBuildingsLabel, "Mostrar edifícios de serviço" },
                ...
                { LocalizationKey.TypePickerTooltipLine2, "Grupos **Cívicos** podem ser atribuídos a qualquer edifício de serviço." },
                ...
                { LocalizationKey.MembershipSectionLabel, "GRUPOS DE DISTRITOS" },
                { LocalizationKey.MembershipSectionTooltipLine1, "Os **grupos de distritos** aos quais este distrito pertence." },
