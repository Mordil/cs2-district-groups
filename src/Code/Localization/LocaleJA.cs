        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            ...
            */
            ...
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.OverlayBorderWidth)), "マップ上に描画される、色付きの地区グループ境界線の幅です。" },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.OverlayBorderAlpha)), "境界線の不透明度" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.OverlayBorderAlpha)), "マップ上に描画される、色付きの地区グループ境界線の不透明度です。\n\n0%で完全に透明、100%で完全に不透明になります。" },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.OverlayBorderHeightOffset)), "高さオフセット" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.OverlayBorderHeightOffset)), "地区グループのオーバーレイが描画される、地形の高さからのオフセットです。" },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.OverlayFillSaturationPercent)), "色付きの地区グループの塗りつぶし範囲の彩度を設定します。\n\n100%ではグループの色がそのまま表示され、値が低いほどグレーに近づきます。" },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.RemoveModData)), "現在のセーブデータにMODが追加したすべての地区グループ、公共施設の割り当て、オーバーレイ用リソースを削除します。" },
                { m_Setting.GetOptionWarningLocaleID(nameof(Setting.RemoveModData)), "このセーブデータからすべての地区グループ、公共施設の割り当て、オーバーレイデータが完全に削除されます。\r\nこの操作は元に戻せません。\r\n続行しますか?" },

                { LocalizationKey.PanelTitle, "District Groups" },
                { LocalizationKey.NewGroupButton, "新規グループ" },
                { LocalizationKey.NewGroupButtonTooltip, "所属する地区がない新しいグループを追加します。" },
                ...
                { LocalizationKey.DisplayDistrictAreasLabel, "すべての地区を表示" },
                { LocalizationKey.ShowGroupOverlayLabel, "グループのオーバーレイを表示" },

                { LocalizationKey.DeleteGroupTooltipLine1, "グループを完全に削除します。" },
                { LocalizationKey.DeleteGroupTooltipLine2, "割り当てられた施設は**稼働地区**を失います。" },
                ...
                { LocalizationKey.DeleteGroupDialogTitle, "地区グループを削除しますか?" },
                { LocalizationKey.DeleteGroupConfirm, "グループを削除" },
                { LocalizationKey.DeleteGroupCancel, "グループを残す" },
                { LocalizationKey.RemoveMemberTooltip, "この地区をグループから削除します。" },
                { LocalizationKey.SelectDistrictsButton, "地区を選択" },
                { LocalizationKey.GroupColorTooltip, "グループの色" },

                { LocalizationKey.ToggleTooltipTitle, "**地区グループ**" },
                { LocalizationKey.ToggleTooltipBody, "地区をグループ化して公共施設に割り当てることで、**稼働地区**を自動的に管理できるようにします。" },

                { LocalizationKey.SectionTooltipLine1, "公共施設には**地区グループ**を割り当てることができます。" },
                { LocalizationKey.SectionTooltipLine2, "割り当てると、そのグループが施設の**稼働地区**を管理します。" },
                { LocalizationKey.SectionTooltipLine3, "割り当てを解除すると、**稼働地区**は手動で管理されます。" },
                { LocalizationKey.SectionTooltipLine4, "注記: 割り当てを変更した後、インフォパネルの表示が更新されるまで数秒かかる場合があります。" },
                { LocalizationKey.SectionLabel, "地区グループ" },
                { LocalizationKey.OperatingDistrictsLabel, "稼働地区" },
                ...
                { LocalizationKey.GroupSearchTitle, "地区グループを選択" },
